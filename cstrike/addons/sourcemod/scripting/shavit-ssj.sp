...
public Plugin myinfo =
{
    name = "[sbavit] SSJ",
    author = "SlidyBat",
    description = "SSJ plugin for shavit's Timer",
    version = "1.1",
    url = ""
}
...
public Action OnPlayerRunCmd( int client, int& buttons, int& impulse, const float vel[3], const float angles[3] )
{
...
void PrintStats( int client, int target, any stats[SSJStats] )
{
    ...
    ColorPrintToChat( client, message );
}
