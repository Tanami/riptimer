...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_prop", SpawnPropCommand, ADMFLAG_GENERIC, "spawns the specified prop");
...
public Action:SpawnPropCommand(client, args)
{
        new String:prop_choice[255];
        GetCmdArg(1, prop_choice, 255);
        ...
        CloseHandle(kv); PropCount[client] += 1;
